...
RUN sed -i '/# Supplemental configuration/a Include conf/extra/foswiki.fcgi.conf' \
        -i '/# Supplemental configuration/a LoadModule fcgid_module modules/mod_fcgid.so' /usr/local/apache2/conf/httpd.conf
