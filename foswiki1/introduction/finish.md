That completes **Scenario 1**, the tour of the Foswiki browser interface. You can navigate to any of the following scenarios from this page. Or click _Next Scenario_ and return to the tutorial home page.
